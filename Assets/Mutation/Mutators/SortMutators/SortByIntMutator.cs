...
{
    public class SortByIntMutator : SortMutator
    {
        private MutableField<int> m_SortDiscriminant = new MutableField<int>() 
        { AbsoluteKey = "TotalScore"};
        [Controllable(LabelText = "Sort Discriminant")]
        public MutableField<int> SortDiscriminant { get { return m_SortDiscriminant; } }
