...
{
    public class GetCurrentPositionMutator : Mutator
    {
        private MutableTarget m_PositionTarget = new MutableTarget() 
        { AbsoluteKey = "Position Vector" };
        [Controllable(LabelText = "Position Target")]
        public MutableTarget PositionTarget { get { return m_PositionTarget; } }

        public override IEnumerator ReceivePayload( VisualPayload payload )
        {
            PositionTarget.SetValue( payload.VisualData.Bound.transform.position, payload.Data );
