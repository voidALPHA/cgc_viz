...
{
    public class IndexInclusionToBoolMutator : TypeConversionAxis<int, bool>
    {
        private MutableField<string> m_InclusionString = new MutableField<string>() 
        { LiteralValue = "All" };
        ...
        protected override bool ConversionFunc( int key, List< MutableObject > entry )
        {
            ...
            return RegroupByIndexInclusionMutator.InclusionFunc( inclusionString )( key );
        }
    }
}
