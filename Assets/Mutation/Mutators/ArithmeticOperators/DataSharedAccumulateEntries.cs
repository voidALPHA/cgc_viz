...
namespace Mutation.Mutators.ArithmeticOperators
{
    public class DataSharedAccumulateEntries : DataMutator
    {
        ...
        public DataSharedAccumulateEntries() : base()
        {
