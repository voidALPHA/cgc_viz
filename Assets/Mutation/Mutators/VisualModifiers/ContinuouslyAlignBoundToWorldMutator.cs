...
{
    public class ContinuouslyAlignBoundToWorldMutator : Mutator
    {
        private MutableField<Quaternion> m_WorldRotation = new MutableField<Quaternion>() 
        { LiteralValue = Quaternion.identity };
        [Controllable(LabelText = "World Rotation")]
        public MutableField<Quaternion> WorldRotation { get { return m_WorldRotation; } }
        ...
        public override IEnumerator ReceivePayload( VisualPayload payload )
        {
            ...
            var worldRotor = newBound.gameObject.AddComponent<WorldAlignedObject>();

            worldRotor.WorldRotation= WorldRotation.GetFirstValue(payload.Data);
    ...
    [UsedImplicitly]
    public class WorldAlignedObject : MonoBehaviour
    {
